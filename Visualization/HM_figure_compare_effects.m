...
[dir_load,app] = HM_OI('home',2,[],varname,method);
file_stats = [dir_load,'Stats_HM_SST_Bucket_deck_level_',num2str(do_NpD),'.mat'];
...
% scatter(a(:,2),a(:,3),ceil(25*a(:,1))+1,a(:,1),'.')
...
if 0,
    ...
    a = imread(file_save);
    b = a([350:end-350],[400:2340 2800:end-400],:);
    imwrite(b,file_save);
end
